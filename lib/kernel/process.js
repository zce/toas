...
//
// Exported because the Host's connection test resolves the refine role the
// same way the Kernel does — one resolution pipeline, no duplication.
export function resolveRole ({ providers, roleConfig, role, secrets, runtime }) {
